...
The program dict.c opens two instances of the same text file, and takes pairs of orthographic text and phonetic text from them, translating the phonetic text from Waxholms STA to NSTs SAMPA, and inserting the pair in the dictionary if it not already exists there.
